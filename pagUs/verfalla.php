...
if(isset($_POST["ver"])){
  ...
  where idrep = '$id'";
  $conn->query($sqlu);
header("Location: indexu.php?pg=falla.php&idrep=$id");
}
$sql="SELECT
    idrep,
    usuariofall,
...
<?php
    ...
    echo "<td><a class='btn btn-warning' href='indexu.php?pg=modfalla.php&idrep=$fila[idrep]'>Mod Roprte</a></td>";
